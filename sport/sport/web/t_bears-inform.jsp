...
<body>
	...
	<section class="hero-wrap hero-wrap-2"
		style="background-image: url('images/t_doosan.png');"
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<h1 class="mb-3 bread">Doosan Bears</h1>
					<p class="breadcrumbs">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 ftco-animate">
					...
					<h2 class="mb-3">DOOSAN BEARS</h2>
					
					<div class="mb-3">
						<h5>2019 LEAGUE</h5>
						<span>팀순위 : 2위<br>	승/패/무 : 57-38-0<br>	승률 : 0.600
					...
					<div class="tag-widget post-tag-container mb-5 mt-5">
						<div class="tagcloud">
							<a href="https://www.doosanbears.com/" 
								class="tag-cloud-link">DOOSAN BEARS</a>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/dir_doosan.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>감독 김 태 형</h3>
							<p>대한민국의 야구선수 출신 감독. 2015년부터  두산 베어스 감독을 맡고 있다.<br>
							선수 시절 베어스의 원클럽맨이였으며,<br>2015 시즌부터는 두산 베어스 제10대 감독으로 취임했다.
							</p>
						</div>
					</div>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/doosan_24.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>주장 오 재 원</h3>
							<p>DOOSAN BEARS No.24 <br>
							DOOSAN BEARS (2007~)
							</p>
						</div>
					</div>
				...
				<div class="col-lg-4 sidebar ftco-animate">
					...
					<div class="sidebar-box ftco-animate">
						...
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.doosaninfracore.com/kr/" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s1.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.wefan.co.kr/" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s2.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.seoul.go.kr/main/index.jsp" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s3.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.seoulmetro.co.kr/kr/index.do?device=PC" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s4.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.sunsoochon.com/" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s5.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.ob.co.kr/" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s6.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.gsretail.com/gsretail/ko/main" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s7.png); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.paldofood.co.kr/" class="blog-img mr-4" 
								style="background-image: url(images/doosan_s8.png); width:200px;"></a>
						</div>
					</div>
