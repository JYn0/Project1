...
$(document).ready(function () {
	...
	mapOption = {
		center: new kakao.maps.LatLng(37.436765, 126.693325),
		level: 3 // 지도의 확대 레벨
	};
	...
	var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
		markerPosition = new kakao.maps.LatLng(37.436765, 126.693325);
...
<body>
	...
	<section class="hero-wrap hero-wrap-2"
		style="background-image: url('images/t_sk.png');"
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<h1 class="mb-3 bread">SK WYVERNS</h1>
					<p class="breadcrumbs">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 ftco-animate">
					...
					<div class="mb-3">
						<h5>2019 LEAGUE</h5>
						<span>팀순위 : 1위<br>	승/패/무 : 63-30-1<br>	승률 : 0.677
					...
					<h3 class="mb-3">인천 SK행복드림구장</h3>
					<p>인천광역시 미추홀구 매소홀로 618 (문학동 482번지)</p>
					<p>
						<div id="map"></div>
					</p>

					<p>좌우거리: 95m 중앙거리: 120m</p>
					<p>23,000석</p>
					<p>1루(홈) / 3루(원정)</p>
					<p>최고의 팬 친화적인 야구장</p>
					...
					<div class="tag-widget post-tag-container mb-5 mt-5">
						<div class="tagcloud">
							<a href="#" 
								class="tag-cloud-link">SK WYVERNS</a>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/dir_sk.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>감독 염 경 엽</h3>
							<p>대한민국의 야구선수 출신 감독. 2019년부터  SK WYVERNS 감독을 맡고 있다.<br>
							선수 시절 태평양 돌핀스와 현대 유니콘스의 유격수
							</p>
						</div>
					</div>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/sk_20.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>주장  이 재 원</h3>
							<p>SK WYVERNS No.20 <br>
							NC DINOS (2006~)
							</p>
						</div>
					</div>
				...
				<div class="col-lg-4 sidebar ftco-animate">
					...
					<div class="sidebar-box ftco-animate">
						...
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.sktelecom.com/index.html" class="blog-img mr-4" 
								style="background-image: url(images/sk_s1.png); width:200px;"></a>
						</div>
					</div>
				</div>
			</div>
