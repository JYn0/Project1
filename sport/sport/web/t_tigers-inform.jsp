...
$(document).ready(function () {
	...
	mapOption = {
		center: new kakao.maps.LatLng(35.168222, 126.889222),
		level: 3 // 지도의 확대 레벨
	};
	...
	var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
		markerPosition = new kakao.maps.LatLng(35.168222, 126.889222);
...
<body>
	...
	<section class="hero-wrap hero-wrap-2"
		style="background-image: url('images/t_kia.png');"
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<h1 class="mb-3 bread">도전 2019시즌!<br>새로운 미래를 여는 KIA타이거즈!! </h1>
					<p class="breadcrumbs">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 ftco-animate">
					...
					<h2 class="mb-3">KIA TIGERS</h2>
					
					<div class="mb-3">
						<h5>2019 LEAGUE</h5>
						<span>팀순위 : 8위<br>	승/패/무 : 38-54-0<br>	승률 : 0.413
					...
					<h3 class="mb-3">광주-기아 챔피언스 필드</h3>
					<p>광주 북구 서림로 10 (우)61255)  지번임동 316</p>
					<p>
						<div id="map"></div>
					</p>

					<p>좌우거리: 99m 중앙거리: 121m</p>
					<p>20,500석</p>
					<p>1루(원정) / 3루(홈)</p>
					<p>국내 최초 개방형 야구장</p>
					...
					<div class="tag-widget post-tag-container mb-5 mt-5">
						<div class="tagcloud">
							<a href="http://www.kiatigers.co.kr/mainSeasonOn.asp" 
								class="tag-cloud-link">KIA TIGERS</a>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/dir_kia.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>감독대행 박 흥 식</h3>
							<p>대한민국의 야구선수 출신 감독. 2019년부터  KIA 타이거즈 감독대행을 맡고 있다.<br>
							MBC-LG 20, 삼성 73, 넥센86, 롯데71, KIA73
							</p>
						</div>
					</div>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img src="images/kia_8.jpg" alt="Image placeholder"
								class="img-fluid mb-4">
						</div>
						<div class="desc">
							<h3>주장 안 치 홍</h3>
							<p>KIA TIGERS No.8 <br>
							KIA TIGERS (2008~)
							</p>
						</div>
					</div>
				...
				<div class="col-lg-4 sidebar ftco-animate">
					...
					<div class="sidebar-box ftco-animate">
						...
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.kia.com/kr/main.html" class="blog-img mr-4" 
								style="background-image: url(images/kia_s1.jpg); width:150px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="https://pib.kjbank.com/ib20/mnu/BPB0000000001" class="blog-img mr-4" 
								style="background-image: url(images/kia_s2.jpg); width:200px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.hitejinro.com/" class="blog-img mr-4" 
								style="background-image: url(images/kia_s3.jpg); width:300px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.hi.co.kr/index.jsp?echo_key=10928959" class="blog-img mr-4" 
								style="background-image: url(images/kia_s4.jpg); width:230px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.hyundai-wia.com/main/main.asp" class="blog-img mr-4" 
								style="background-image: url(images/kia_s5.jpg); width:220px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="http://www.mobis.co.kr/" class="blog-img mr-4" 
								style="background-image: url(images/kia_s6.jpg); width:170px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.jejuair.net/jejuair/kr/main.do" class="blog-img mr-4" 
								style="background-image: url(images/kia_s7.jpg); width:230px;"></a>
						</div>
						<div class="block-21 mb-4 d-flex">
							<a href="https://www.daemyungresort.com/bs" class="blog-img mr-4" 
								style="background-image: url(images/kia_s8.jpg); width:230px;"></a>
						</div>
					</div>
